						...
						<div className="col-lg-8 mt-lg-0 mt-20">
							<div className="row gap-sm-0">
								<FooterLink title='Company'>
									<LinkItem title='About Us' href='/' />
									<LinkItem title='Press Release' href='/' />
									<LinkItem title='Terms of use' href='/' />
									<LinkItem title='Privacy & Policy' href='/' />
								</FooterLink>
								<FooterLink title='Support'>
									<LinkItem title='Refund Policy' href='/' />
									<LinkItem title='Unlock Rewards' href='/' />
									<LinkItem title='Live Chatting' href='/' />
								</FooterLink>
								<FooterLink title='Connect'>
									<LinkItem title='hi@store.gg' href='/' />
									<LinkItem title='team@store.gg' href='/' />
									<LinkItem title='Pasific 12, Jakarta Selatan' href='/' />
									<LinkItem title='021 - 1122 - 9090' href='/' />
								</FooterLink>
							</div>
						</div>
					</div>
