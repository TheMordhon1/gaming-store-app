							...
							<form action="">
								<div className="photo d-flex">
									<div className="position-relative me-20">
										<Image src="/img/avatar-1.png" width={90} height={90} className="avatar img-fluid" alt="avatar-user" />
										<div
											className="avatar-overlay position-absolute top-0 d-flex justify-content-center align-items-center">
											<Image className="icon upload" src='/icon/upload.svg' width={24} height={24} alt="icon-upload" />
										</div>
									</div>
